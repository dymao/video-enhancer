# Video Enhancer - 视频增强工具

一款基于 PyQt5 的视频下载与增强工具，支持 AI 超分辨率、FFmpeg 高清处理、音视频同步等功能。

## ✨ 功能特点

- **视频下载**：支持从主流视频网站下载视频（Bilibili、YouTube、抖音等）
...
![Video Enhancer 界面截图](docs/images/screenshot.png)
...
1. **输入视频链接**：在界面中输入视频 URL（如 Bilibili 视频链接）
